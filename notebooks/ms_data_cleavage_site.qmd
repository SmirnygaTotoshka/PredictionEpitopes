...
not.spliced = proteasome.data[proteasome.data$spliceType  == "" & 
                                ...
                                proteasome.data$PTM  == "",]
kable(not.spliced %>% count(substrateOrigin))
...
kable(head(i.sites.stat, n = 10))
kable(table(i.sites.stat$N))
...
kable(head(s.sites.stat,n = 10))
kable(table(s.sites.stat$N))
```
